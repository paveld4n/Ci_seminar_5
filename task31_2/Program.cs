/// Задать массив из 12 элементов, заполненный случайными числами от -9 до 9. Найти сумму отрицательный и положительных чисел. С Кортеже
...
// int sumnegativnum = GetSumNegative(numbres); вместо данной строки можно подставить вызов метода сразу в стоку вывода консоли
